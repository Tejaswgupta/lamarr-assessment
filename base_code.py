...
def add_entry(court_name, case_name, bench_name, doc_id, citations):
    # TODO: Save the information to CSV
    pass
...
try:
    ...
    notif_link.click()
    print('push_notification allowing')
except Exception as e:
    print(e)
    print('push_notification not allowing or doesnt appear')
...
try:
    ...
    notif_link.click()
    print('pop_up closing')
except Exception as e:
    print(e)
    print('pop_up not closing or doesnt appear')
...
try:
    ...
    print(e)
    print('not allowing to login in same account')
...
print('Clicking on Browse judgements by Court/Tribunals')
# browse_link.click()
    ...
    try:
        ...
        if inner_text != "":
            with open(
                ...
                scc_id = driver.find_element(
                    By.CLASS_NAME, 'SectionheadText').text
                print(scc_id)
                ...
                writer.writerow([case_name, case_no, date,
                                advocates, citations, inner_text])
    ...
    for depth in range(1, 32):
        ...
        try:
            ...
            for li_element in li_elements:
                ...
                # Perform actions after clicking the li element
                # Add your logic here, for example, reading data
                print("Out")
                read_data(driver)
